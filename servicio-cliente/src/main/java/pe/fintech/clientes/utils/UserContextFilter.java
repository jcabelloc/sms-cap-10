package pe.fintech.clientes.utils;
...
public class UserContextFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        logger.debug("Entering the UserContextFilter for the servicio-cliente");
        HttpServletRequest httpServletRequest = (HttpServletRequest) servletRequest;
        logger.debug("I am entering the servicio-cliente id with auth token: ", httpServletRequest.getHeader("Authorization"));
        ...
        logger.debug("***** I am entering the servicio-cliente id with correlation id: {}" ,correlationId);
